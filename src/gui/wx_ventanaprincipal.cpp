...
GUIFrame::GUIFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	box_resultados = new wxBoxSizer( wxVERTICAL );
	...
	box_resultados->Add( radio_comparacion, 0, wxALL, 5 );
	...
	filtro_asignaturas = new wxStaticBoxSizer( new wxStaticBox( panel_resultados, wxID_ANY, wxT("Lista de códigos de asignaturas separados por comas (si está vacía, entonces son todas las asignaturas)") ), wxVERTICAL );
	...
	m_staticText16 = new wxStaticText( panel_resultados, wxID_ANY, wxT("Número de iteraciones : "), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText16->Wrap( -1 );
	gSizer51->Add( m_staticText16, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	input_numero_iteraciones = new wxTextCtrl( panel_resultados, wxID_ANY, wxT("5"), wxDefaultPosition, wxDefaultSize, wxTE_CENTRE );
	gSizer51->Add( input_numero_iteraciones, 0, wxALIGN_BOTTOM|wxALL, 5 );
	...
	gSizer51->Add( check_mostrar_puntajes_minimos, 0, wxALIGN_CENTER|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	gSizer51->Add( boton_buscar, 0, wxALIGN_CENTER|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALIGN_LEFT|wxALL, 5 );
	...
	input_peso = new wxStaticText( panel_resultados, wxID_ANY, wxT("Peso óptimo"), wxDefaultPosition, wxDefaultSize, 0 );
	input_peso->Wrap( -1 );
	...
	input_puntaje = new wxStaticText( panel_resultados, wxID_ANY, wxT("Puntaje óptimo"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText13 = new wxStaticText( panel_resultados, wxID_ANY, wxT("Fiabilidad (menor es mejor) : "), wxDefaultPosition, wxDefaultSize, 0 );
	...
	box_resultados->Add( gSizer4, 0, wxEXPAND, 5 );

	panel_resultados->SetSizer( box_resultados );
	panel_resultados->Layout();
	box_resultados->Fit( panel_resultados );
