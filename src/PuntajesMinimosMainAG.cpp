...
void PuntajesMinimosFrame::BotonBuscar( wxCommandEvent& event ){
    ...
    {
        FenotipoIPMPAIS *fenotipo=new FenotipoIPMPAIS(cuantosComponentesExamenIngreso, puntajeMinimo_minimo, puntajeMinimo_maximo, ponderacion_minimo, ponderacion_maximo, admisionesUnivalle, listaEgresadosOrdenada, cuantosEgresados);
